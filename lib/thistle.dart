...
part "src/impl/observable_map.dart";
part "src/impl/callback_support.dart";
part "src/impl/memory_graph.dart";
part "src/graphson.dart";
part "src/utils.dart";

/// A graph database experiment with the Dart language and its ecosystem.
/// 
/// I was interested in graph databases for another project and as with 
/// most learning processes it is usually better to work on something you 
/// are interested in. So here it is "yet another graph database".
/// 
/// Due to my cultural heritage its called "thistle" rather than "yagd".
/// 
/// If this is useful to anyone then all the better.
/// 
/// Thistle provides interfaces to a directed property graph model. In this model 
/// both vertices and edges have properties, edges have direction a label and references
/// to the vertices that they come from and go to and vertices have collections of 
/// incomming and outgoing edges. The graph interface provides mechanisms for creation
/// and destruction of edges and vertices, accessors for thier respective iterators and
/// callback mechanisms for those who may be interested in the mutation events associated
/// with a graph.
/// 
/// In addition to the programmatic means of graph construction there is also support for 
/// import and export of graphs using the Tinkerpop GraphSON format.
/// 
/// Getting started -
///     
...
class Thistle {
  static IGraph newMemoryGraph() => new _MemoryGraph(); 
}
